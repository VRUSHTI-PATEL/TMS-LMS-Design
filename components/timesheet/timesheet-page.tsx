...
export function TimesheetPage({ isDarkMode }: TimesheetPageProps) {
  ...
  return (
    <div className={`p-3 sm:p-6 space-y-4 sm:space-y-6 ${isDarkMode ? "text-white bg-gray-900" : "text-gray-900 bg-gray-50"}`}>
      ...
      <Card className={`${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}>
        <CardContent className="p-3 sm:p-4">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <h1 className={`text-lg sm:text-xl font-semibold ${isDarkMode ? "text-white" : "text-gray-800"}`}>Add/View Timesheet</h1>
          </div>
          ...
          <Collapsible open={isGuidelinesOpen} onOpenChange={setIsGuidelinesOpen}>
            ...
            <CollapsibleContent className="mb-4">
              <div
                className={`p-3 sm:p-4 rounded-lg border ${isDarkMode ? "bg-gray-800 border-gray-700 text-gray-300" : "bg-blue-50 border-blue-200 text-blue-800"}`}
              >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
            ...
            <div className="flex items-center gap-4">
              <div className="text-sm">
                <span className={isDarkMode ? "text-gray-300" : "text-gray-600"}>Weekly Total: </span>
                <span className="font-semibold text-blue-600">{weekTotalHours.toFixed(1)}h</span>
                <span className={`ml-2 ${isDarkMode ? "text-gray-400" : "text-gray-500"} hidden sm:inline`}>Target: 40h</span>
                <div className={`sm:hidden ${isDarkMode ? "text-gray-400" : "text-gray-500"} text-xs`}>Target: 40h</div>
              </div>
            </div>
          </div>
        ...
        <CardHeader className="pb-3 px-3 sm:px-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <CardTitle className={`text-base sm:text-lg ${isDarkMode ? "text-white" : "text-gray-900"}`}>{selectedDate}</CardTitle>
              <div className="flex items-center gap-2">
                {getDayStatus(weekDays.find((d) => d.full === selectedDate)) && (
                  <Badge
                    variant="outline"
        ...
        <CardContent className="px-3 sm:px-6">
          ...
          <div className="space-y-4">
            ...
            <div className="overflow-x-auto">
              <div
                className={`grid grid-cols-12 gap-4 text-sm font-medium border-b pb-2 min-w-[800px] ${isDarkMode ? "text-gray-300 border-gray-600" : "text-gray-600 border-gray-200"}`}
              >
                <div className="col-span-3">ENGAGEMENT</div>
                <div className="col-span-2">TASK</div>
                <div className="col-span-1">HOURS</div>
            ...
            {(isAddingEntry || editingEntry) && (
              <div
                className={`border-b rounded-lg p-3 ${isDarkMode ? "border-gray-600 bg-gray-700" : "border-gray-200 bg-blue-50"}`}
              >
                {/* Desktop Grid Layout */}
